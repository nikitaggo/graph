...
constexpr uint32_t COL_DOT = 0xffff;
...
int main() {
	...
	for (double step_X = count_dots_X_Y; step_X > -count_dots_X_Y; step_X -= 0.8) {
		for (double step_Y = count_dots_X_Y; step_Y > -count_dots_X_Y; step_Y -= 0.05) {
	...
	for (double stepX = count_dots_X_Y; stepX > -count_dots_X_Y; stepX -= 0.05) {
		for (double stepY = count_dots_X_Y; stepY > -count_dots_X_Y; stepY -= 0.8) {
